...
export default function SheetSet1() {
  return (
    <div className="bg-bg-secondary rounded-lg border overflow-hidden border-border-tertiary-opaque">
      <Tabs defaultValue="orders" className="w-full gap-0">
        <TabsList className="bg-bg-primary w-full rounded-none">
          <TabsTrigger className="flex-none" value="orders">
            Orders
          </TabsTrigger>
          <TabsTrigger className="flex-none" value="materials">
            Materials
          </TabsTrigger>
          <TabsTrigger className="flex-none" value="locations">
            Locations
          </TabsTrigger>
          <TabsTrigger className="flex-none" value="services">
            Services
          </TabsTrigger>
          <TabsTrigger className="flex-none" value="network">
            Network
          </TabsTrigger>
        </TabsList>
        <TabsContent value="orders">
          <div className="p-4 text-body-sm text-fg-secondary">10 rows</div>
        </TabsContent>
        ...
        <TableBody>
          {products.map((product, i) => (
            <TableRow key={product.sku}>
              <TableCell className="px-4 text-body-sm text-fg-secondary font-mono">
                {i + 1}
              </TableCell>
